...
age = '26'
print('You are ' + age)  # Print out a string and a variable including another string

age = 26
string_4 = str(age)  # Convert data type from number to string, then connect to another string
...
terry_greeting = greeting_1.format(name)
